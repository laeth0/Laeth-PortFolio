        ...
        <div className="bg-MainBg w-full min-h-[77vh]  grid md:grid-cols-12 border border-GeneralBorder border-solid ">
            ...
            <div className="md:col-span-2 flex gap-2 flex-wrap">
                ...
                <div className="hidden Tablet:flex flex-col gap-4 p-2">
                    <Image src="/Terminal.svg" loading={"lazy"} alt="Terminal" width="20" height="20"/>
                    <Image src="/personal-info-icon.svg" loading={"lazy"} alt="Terminal" width="20" height="20"/>
                    <Image src="/hobbies-icon.svg" loading={"lazy"} alt="Terminal" width="20" height="20"/>
                </div>
                {/* According */}
                    ...
                    <details className="group">
                        ...
                        <div className="my-3 group-open:animate-fadeIn ">
                            <div className="flex ps-2 gap-1">
                                <Image src="Arrow.svg" loading={"lazy"} alt="Arrow.svg" height="10" width="10"/>
                                <Image src="/OrangeFile.svg" loading={"lazy"} alt="OrangeFile.svg" height="15" width="15"/>
                                <span className="text-white">bio</span>
                            </div>
                            <div className="flex ps-2 gap-1">
                                <Image src="Arrow.svg" loading={"lazy"} alt="Arrow.svg" height="10" width="10"/>
                                <Image src="/GreenFile.svg" loading={"lazy"} alt="OrangeFile.svg" height="15" width="15"/>
                                <span>interests</span>
                            </div>
                            <div className="flex ps-2 gap-1">
                                <Image src="Arrow.svg" loading={"lazy"} alt="Arrow.svg" height="10" width="10"/>
                                <Image src="/BlueFile.svg" loading={"lazy"} alt="OrangeFile.svg" height="15" width="15"/>
                                <span>education</span>
                            </div>
                            <div className="flex ps-2 gap-1">
                                <Image src="Arrow.svg" className="invisible" loading={"lazy"} alt="Arrow.svg" height="10" width="10"/>
                                <Image src="/Markdown.svg" loading={"lazy"} alt="Markdown.svg" height="15" width="15"/>
            ...
            <div className="flex flex-col md:col-span-10">
                ...
                <div className="border-b hidden md:flex border-GeneralBorder border-solid text-xs xl:text-sm">
                    <div className="flex gap-8 py-2 px-4 border-e w-fit h-full border-GeneralBorder border-solid">
                        <span>personal-info</span>
                        <Image loading={"lazy"} src="/Close.svg" className="select-none" alt="Close" width="10" height="10"/>
                    </div>
                </div>
...
*/`}
                        ...
                        <div className="flex flex-col">
                            <div className="flex justify-between ">
                                <div className="flex gap-2">
                                    <Image src="/userImage.png" loading={"lazy"} className="select-none h-3/4 w-auto" alt="user Image"
                                           width="36" height="36"/>
                                    <div className="flex flex-col">
                                ...
                                <div className="flex gap-4">
                                    <div className="flex gap-1 items-center">
                                        <Image src="/Comment.svg" className="select-none" loading={"lazy"} alt="Comment.svg"
                                               width="15"
                                               height="15"/>
                                        <span className="hover:text-white duration-300">details</span>
                                    </div>
                                    <div className="flex gap-1 items-center">
                                        <Image src="/Star.svg" className="select-none" loading={"lazy"} alt="Star.svg" width="15"
                                               height="15"/>
  ...
  return value;
                        ...
                        <div className="flex flex-col">
                            <div className="flex justify-between">
                                <div className="flex gap-2">
                                    <Image src="/userImage.png" className="select-none h-3/4 w-auto" loading={"lazy"} alt="user Image"
                                           width="36" height="36"/>
                                    <div className="flex flex-col">
                                        <span className="text-SecondaryBlue ">@Laeth0</span>
                                        <span>Created 5 months ago</span>
                                ...
                                <div className="flex gap-4 items-center">
                                    <div className="flex gap-1 ">
                                        <Image src="/Comment.svg" className="select-none" loading={"lazy"} alt="Comment.svg" width="15"
                                               height="15"/>
                                        <span className="hover:text-white duration-300">details</span>
                                    </div>
                                    <div className="flex gap-1">
